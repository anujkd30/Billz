 ...
 * @author Anuj
 */
public class UnsubscribeProduct extends javax.swing.JFrame {

    /**
     * Creates new form UnsubscribeProduct
     */
    public UnsubscribeProduct() {
        initComponents();
        myInits();
    ...
    private void initComponents() {
        ...
        deleteProductLabel.setFont(new java.awt.Font("Ubuntu", 1, 28)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(deleteProductLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void productListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_productListMouseClicked
        ...
        try{
            Statement stmt = SqlConnection.getStat();
            String sql = "delete from subscription where customer_id = '"+Customer.id+"' and product_id = '"+productId+"'";
            stmt.execute(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnsubscribeProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UnsubscribeProduct().setVisible(true);
            }
        });
    }
